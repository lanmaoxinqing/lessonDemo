...
- (void)createIntroView{
    ...
    CGFloat barY = self.view.frame.size.height - barHeight-44;
    _introLabel = [[UILabel alloc] init];
    _introLabel.textColor=[UIColor whiteColor];
    _introLabel.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:.3];
    _introLabel.numberOfLines=0;
    _introLabel.font=[UIFont systemFontOfSize:17];
    _introLabel.textAlignment=NSTextAlignmentCenter;
    _introLabel.frame = CGRectMake(0, barY, self.view.frame.size.width, barHeight);
    _introLabel.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
